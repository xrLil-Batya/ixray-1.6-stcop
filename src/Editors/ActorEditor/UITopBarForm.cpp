...
void UITopBarForm::Draw()
{
    ...
    ImGui::Begin("TOOLBAR", NULL, window_flags);
    {
        ...
        m_tNew->Load();
        if (ImGui::ImageButton(m_tNew->get_SRView(), ImVec2(20, 20), ImVec2(0, 0), ImVec2(1, 1), 0))
        {
            ClickNew();
        }
        if (ImGui::IsItemHovered())
        ...
        ImGui::SameLine();
        m_tSave->Load();
        if (ImGui::ImageButton(m_tSave->get_SRView(), ImVec2(20, 20), ImVec2(0, 0), ImVec2(1, 1), 0))
        {
            ClickSave();
        }
        if (ImGui::IsItemHovered())
